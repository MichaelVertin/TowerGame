    ...
    namespace ParticleSystems
    {
        ...
        namespace Demos
        {
            ...
            public class DemoManager : MonoBehaviour
            {
                ...
                [SerializeField] private float distFromCamera = 0.0f;
...
////////////// added
                    if (InputManager.WasKeyPressedThisFrame("w")) // if (Input.GetAxis("Mouse ScrollWheel") < 0)
                    {
                        Next();
                    }
                    else if (InputManager.WasKeyPressedThisFrame("q")) // if (Input.GetAxis("Mouse ScrollWheel") > 0)
                    {
                        Previous();
                    }
                    ...
                    if (InputManager.WasKeyPressedThisFrame("u"))
                    {
                    ...
                    if (InputManager.WasKeyPressedThisFrame("o"))
                    {
                    ...
                    // Cycle levels.
                    /*
                    if (InputManager.WasKeyPressedThisFrame("l"))
                    {
                    ...
                    */
                    ...
                    if (InputManager.WasKeyPressedThisFrame("r"))
                    {
...
//                        Vector3 mousePosition = Input.mousePosition;
                        ...
                        if (InputManager.WasKeyPressedThisFrame("0"))
                        {
...
//                            oneshotParticleSystems.InstantiateParticlePrefab(mousePosition, mouse.distanceFromCamera);
                            oneshotParticleSystems.InstantiateParticlePrefab(Vector3.zero, distFromCamera);//mouse.distanceFromCamera);
                        }
                        if (InputManager.IsKeyPressed("1"))
                        {
//                            oneshotParticleSystems.InstantiateParticlePrefab(mousePosition, mouse.distanceFromCamera);
                            oneshotParticleSystems.InstantiateParticlePrefab(Vector3.zero, distFromCamera);
                        }
                    }
